                        ...
                        <div class="box-body">
                            <form method="POST" id="new_service" action="#">
                                {{csrf_field()}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="s_service">Select Network</label>
                                            <select id="s_service" class="form-control" name="network" required>
                                                <option value="" disabled="disabled" selected="selected">Select an option</option>
