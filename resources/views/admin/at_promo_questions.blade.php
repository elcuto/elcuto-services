    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add AT Promo Questions</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-8">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">New <strong>AT Promo</strong> Questions</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                ...
                <div class="col-md-4">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">Load From File(Excel) - <strong>AT Promo</strong></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
@section('scripts')
    ...
    <script>
        ...
        $('#add_questions').submit(function(event){
            ...
            var title = 'Add Question To AT Promo';
            Swal.fire({
                title: title,
                text: "Are you sure?",
                icon: 'warning',
        ...
        $('#excelQuestionsLoad').submit(function(event){
            ...
            var title = 'Uploading AT Promo Questions File';
            Swal.fire({
                title: title,
                text: "Are you sure?",
                icon: 'warning',
