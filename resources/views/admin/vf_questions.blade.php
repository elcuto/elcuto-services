    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Vodafone Promo Questions</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">Vodafone Promo Questions</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
@section('scripts')
    ...
    <script>
        ...
        function deleteQuestion(id){
            var title = 'Delete Vodafone Promo Question ';
            Swal.fire({
                title: title,
                text: "Are you sure?",
                icon: 'warning',
