...
return new class extends Migration
{
    ...
    {
        Schema::create('tb_at_service_subscriptions_done', function (Blueprint $table) {
            $table->id();
            ...
            $table->string("in_error")->nullable();
            $table->string("request_id", 50)->nullable();
            $table->string("code")->nullable();
            $table->string("transaction_id", 100)->nullable();
            $table->string("subscription_result")->nullable();
            $table->string("subscription_error")->nullable();
    ...
    {
        Schema::dropIfExists('tb_at_service_subscriptions_done');
    }
};
